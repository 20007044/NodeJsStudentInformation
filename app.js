...
const host='0.0.0.0';
mongoose.connect('mongodb+srv://akshaygupta42:Coldblot@70@cluster0.se5soo7.mongodb.net/?retryWrites=true&w=majority', { dbName: 'StudentInformationSystem' }).then('Connected database').catch(e => console.log(e));
